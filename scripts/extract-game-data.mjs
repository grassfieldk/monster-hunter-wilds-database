...
for (const name of ['items', 'monsters', 'quests', 'lookups', 'item-uses', 'item-sources', 'source', 'armor', 'armor-series', 'armor-upgrades', 'armor-upgrade-recipes', 'armor-recipes', 'amulets', 'amulet-recipes', 'weapons', 'weapon-recipes', 'weapon-trees', 'decorations', 'decoration-probabilities', 'skills', 'skill-levels', 'artian-skill-data', 'kinsects', 'kinsect-recipes']) {
